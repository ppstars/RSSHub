...
// pp
router.get('/1pp/smzdmHaowen', require('./routes/1pp/smzdmHaowen.js'));
router.get('/1pp/a9vg', require('./routes/1pp/a9vg.js'));
router.get('/1pp/bahamute/:boardid', require('./routes/1pp/bahamute.js'));
router.get('/1pp/Gouhuoyingdi_jingxuan', require('./routes/1pp/Gouhuoyingdi_jingxuan'));
router.get('/1pp/csdn_blog/:id', require('./routes/1pp/csdn_blog.js'));
router.get('/1pp/lvdong_index', require('./routes/1pp/lvdong_index.js'));
router.get('/1pp/lianwen_index', require('./routes/1pp/lianwen_index.js'));
router.get('/1pp/lianbushou_index', require('./routes/1pp/lianbushou_index.js'));
...
router.get('/bihu/index', require('./routes/bihu/index'));
